...
function load_stylesheets()
{
    ...
    wp_register_style('animate-on-scroll-css', 'https://cdnjs.cloudflare.com/ajax/libs/aos/2.3.4/aos.css', array(), false, 'all');
...
function load_scripts()
{
    ...
    wp_register_script('animate-on-scroll-js', 'https://cdnjs.cloudflare.com/ajax/libs/aos/2.3.4/aos.js', false, true); 
    // Custom js
